...
public String getResponse(String statement)
 ...
 It is almost the same except for the comments and the answer key has one extra method
...
Under one method, what could you have done differently? 
Not much
...
How similar is your code to the one provided? 
It is very similar, we use the same tactics to find the phrase wanted. I used booleans, that's what answer key did.

Is your code more or less efficient? 
Almost the same, slightly less efficient because I looked for letters before the statement when it would have been more efficient to look for symbols.
